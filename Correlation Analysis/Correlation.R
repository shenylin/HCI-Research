#Fireside Exploration Analysis (0927 updated)
...
#Read in Data
library(readr)
FEData.raw <- read_csv("Fireside Exploration Dataset - Combined Dataset_0920updated.csv", col_names = TRUE)
head(FEData.raw) 
View(FEData.raw) 
...
###Pearson Correlation - Formal Group (Formality_Group: 1)
setwd("~/Downloads/ACTION Lab")

#Read in Data
library(readr)
COR_F.raw <- read_csv("Fireside Exploration Dataset - Correlation Dataset_Formal.csv", col_names = TRUE)
head(COR_F.raw) 
View(COR_F.raw) 
...
library(gplots)
library(ggplot2)
FE_COR_F <- COR_F.raw[c(23,30,35,39,43,47,51,55)]
FE_COR_F
names(FE_COR_F)


cor(FE_COR_F)
corrplot.mixed(corr=cor(FE_COR_F, use="complete.obs"),
               upper="ellipse", tl.pos="lt")



###Pearson Correlation - Casual Group (Formality_Group: 0)
setwd("~/Downloads/ACTION Lab")

#Read in Data
library(readr)
COR_C.raw <- read_csv("Fireside Exploration Dataset - Correlation Dataset_Casual.csv", col_names = TRUE)
head(COR_C.raw) 
View(COR_C.raw) 
...
library(gplots)
library(ggplot2)
FE_COR_C <- COR_C.raw[c(23,30,35,39,43,47,51,55)]
FE_COR_C
names(FE_COR_C)


cor(FE_COR_C)
corrplot.mixed(corr=cor(FE_COR_C, use="complete.obs"),
               upper="ellipse", tl.pos="lt")


---------------------------------------------------------------
  
## 0927 UTAUT, Big 5, 3 DVs => 18 measurements
...
#Read in Data
library(readr)
COR_F.raw <- read_csv("Fireside Exploration Dataset - Dataset_formal group.csv", col_names = TRUE)
head(COR_F.raw) 
View(COR_F.raw) 
...
library(gplots)
library(ggplot2)
FE_COR_F <- COR_F.raw[c(23,30,35,39,43,47,51,55,63,68,73,76,81,86,91,95,100,106)]
FE_COR_F
names(FE_COR_F)
...
corrplot(cor(FE_COR_F), addCoef.col = 1,    # Change font size of correlation coefficients
         number.cex = 0.5)
...
#Read in Data
library(readr)
COR_C.raw <- read_csv("Fireside Exploration Dataset - Dataset_casual group.csv", col_names = TRUE)
head(COR_C.raw) 
View(COR_C.raw) 
...
library(gplots)
library(ggplot2)
FE_COR_C <- COR_C.raw[c(23,30,35,39,43,47,51,55,63,68,73,76,81,86,91,95,100,106)]
FE_COR_C
names(FE_COR_C)
...
corrplot(cor(FE_COR_C), addCoef.col = 1,    # Change font size of correlation coefficients
         number.cex = 0.5)
